<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayByType.aspx.cs" Inherits="ElfaInstall.Reports.PayByType" %>
...
<head runat="server">
    <title>Pay by Payment Type Report</title>
</head>
<body>
    ...
    <br />
    <div style="font-size:22px; font-weight:bold; color:#666666;"><center><br />Pay by Payment Type Report</center></div>
    <br /><br />
        <table width="740">
            <tr>
