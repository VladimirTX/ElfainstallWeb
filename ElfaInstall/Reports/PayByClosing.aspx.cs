...
{
    public partial class PayByClosing : System.Web.UI.Page
    {
        ...
        protected void BtnCompletedClick(object Sender, EventArgs E)
        {
            if (rdpStart.SelectedDate != null && rdpEnd.SelectedDate != null)
            {
                ...
                objComm.CommandText = "pLogPayByClosing";
        ...
        private void ShowReport()
        {
            ...
            if (_drInfo.HasRows)
            {
                ...
                try
                {
                    ...
                    WorksheetCell cellH = row.Cells.Add("Pay By Closing Date Report");
                    cellH.MergeAcross = 4;
