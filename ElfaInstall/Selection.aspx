<%@ Page Title="Order Search" Language="C#" MasterPageFile="~/MasterNew.Master" AutoEventWireup="true" CodeBehind="Selection.aspx.cs" Inherits="ElfaInstall.Selection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 500px;" cellpadding="0" cellspacing="2">
        ...
        <tr>
            ...
            <td  style="width: 100px;" align="left"><asp:Button ID="btnOrderNumb" runat="server" Text="Search" CssClass="btnmenu" OnClick="btnOrderNumb_Click" PostBackUrl="~/Orders.aspx" ValidationGroup="Order" /></td>
        </tr>
        <tr><td colspan="3"><hr /></td></tr>
        <tr>
            ...
            <td align="Left"><asp:Button ID="btnStore" runat="server" Text="Search" CssClass="btnmenu" OnClick="btnStore_Click" PostBackUrl="~/Orders.aspx" ValidationGroup="Store" /></td>
        </tr>
        <tr><td colspan="3"><hr /></td></tr>
        <tr>
            ...
            <td align="left"><asp:Button ID="btnVendor" runat="server" Text="Search" CssClass="btnmenu" OnClick="btnVendor_Click" PostBackUrl="~/Orders.aspx" ValidationGroup="Vendor" /></td>
        </tr>
        <tr><td colspan="3"><hr /></td></tr>
        <tr>
            ...
            <td align="left"><asp:Button ID="btnMarket" runat="server" Text="Search" CssClass="btnmenu" OnClick="btnMarket_Click" PostBackUrl="~/Orders.aspx" ValidationGroup="Market" /></td>
        </tr>
        <tr><td colspan="3"><hr /></td></tr>
        <tr>
            ...
            <td align="left" valign="middle"><asp:Button ID="btnName" runat="server" Text="Search" CssClass="btnmenu" OnClick="btnName_Click" PostBackUrl="~/Orders.aspx" /></td>
        </tr>
        ...
        <tr>
            ...
            <td align="left" valign="middle"><asp:Button ID="btnDates" runat="server" Text="Search" CssClass="btnmenu" OnClick="btnDates_Click" PostBackUrl="~/Orders.aspx" ValidationGroup="Date" /></td>
        </tr>
        <tr><td colspan="3"><hr /></td></tr>
        <tr>
...
<%--                    <asp:ListItem Value="COM">Commercial</asp:ListItem>--%>
            ...
            <td align="left"><asp:Button ID="btnOptions" runat="server" Text="Search" 
                    CssClass="btnmenu" PostBackUrl="~/Orders.aspx" ValidationGroup="Market" 
