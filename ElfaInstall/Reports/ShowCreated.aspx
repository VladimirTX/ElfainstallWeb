<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowCreated.aspx.cs" Inherits="ElfaInstall.Reports.ShowCreated" %>
    ...
    <center>
        <asp:table id="tblTop" runat="server" CellSpacing="0" Width="760px" CellPadding="0">
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Center" Font-Bold="True" Font-Size="12" Height="30" VerticalAlign="Top">
                    <asp:Label runat="Server" ID="lblHeader">Orders Created&nbsp;&nbsp;from </asp:Label>&nbsp;
        ...
        <asp:GridView runat="Server" ID="grdStores" Width="760px" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Total" HeaderText="Total number of orders">
        ...
        <asp:GridView runat="Server" ID="grdMarkets" Width="760px" 
            DataSourceID="sdsOrders" AutoGenerateColumns="False" BorderColor="Black" 
            BorderStyle="Solid" BorderWidth="2px" CellPadding="5" Font-Names="Arial" 
            Font-Size="10px" ForeColor="Black" Visible="False">
            <Columns>
        ...
        <asp:GridView runat="Server" ID="grdVendors" Width="760px" 
            DataSourceID="sdsOrders" AutoGenerateColumns="False" BorderColor="Black" 
            BorderStyle="Solid" BorderWidth="2px" CellPadding="5" Font-Names="Arial" 
            Font-Size="10px" ForeColor="Black" Visible="False">
            <Columns>
