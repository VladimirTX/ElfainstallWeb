<%@ Page Title="Open Orders" Language="C#" MasterPageFile="~/MasterNew.Master" AutoEventWireup="true" CodeBehind="OrdersR.aspx.cs" Inherits="ElfaInstall.OrdersR" %>
    ...
    <table style="width: 1000px; font-size:smaller;" cellpadding="0" cellspacing="2">
        <tr>
            <td style="width:160" align="right">
                Search by Order# 
                <asp:TextBox ID="txtOrderNumb" runat="server" Width="100px"></asp:TextBox></td>
            <td style="width:100" align="left">
                <asp:Button ID="btnSearch1" runat="server" Text="Search" CssClass="btnmenu" 
                    onclick="BtnSearch1Click"/>
            </td>
            <td style="width:220" align="right">
                Customer Last Name OR First Name 
                <asp:TextBox ID="txtCustName" runat="server" Width="100px"></asp:TextBox>
            </td>
            <td style="width:100" align="center">
                <asp:Button ID="btnSearch2" runat="server" Text="Search" CssClass="btnmenu" 
                    onclick="BtnSearch2Click"/>
            </td>
            <td style="width:360" align="center">
                <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btnmenu" OnClick="BtnResetClick" />
            </td>
        </tr>
        <tr>
