<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintOrder.aspx.cs" Inherits="ElfaInstall.PrintOrder" %>
...
<%--            <tr><td colspan="3"><hr style=" color:Black; height:4px" /></td></tr>--%>
        ...
        <table width="740" style=" color:Black">
            ...
            <tr>
                ...
                <td valign="top" class="td12a">Order Status</td>
                <td valign="top" align="left">
<%--                    <asp:Label ID="lblInstallPref" runat="server" CssClass="lblsize12a" Text="" Width="159px"></asp:Label>--%>
        ...
        <table width="740">
            <tr>
                ...
                <td class="td12a" style="width: 79px">&nbsp;</td>
...
<%--        <span style="font-size:18px; color:#C32735; font-family: Arial;  font-weight:bold;">Installation Charges</span>--%>
...
<%--                    (<asp:Label runat="server" ID="lblProc">30</asp:Label>% of non-sale purchase price)--%>
                </td>
            ...
            <tr>
                ...
                <td align="right">
                    <asp:Label ID="lblMiscPrice" runat="server" CssClass="lblmoneya">$ __________</asp:Label></td>
                <td style="width: 244px;">&nbsp;</td>
            </tr>
            <tr>
                <td class="td12a">
                ...
                <td align="right">
                    <asp:Label ID="Label4" runat="server" CssClass="lblmoneya">$ __________</asp:Label></td>
                <td style="width: 244px;">&nbsp;</td>
            </tr>
            <tr>
                <td class="td12a">
                    Adjustment:</td>
                <td align="right">
                    <asp:Label ID="lblDiscount" runat="server" CssClass="lblmoneya">$ __________</asp:Label></td>
                <td style="width: 244px;">&nbsp;</td>
            </tr>
            <tr>
                <td class="td12a">
                    Other</td>
                <td align="right">
                    <asp:Label ID="lblOther" runat="server" CssClass="lblmoneya">$ __________</asp:Label></td>
                <td style="width: 244px;">&nbsp;</td>
            </tr>
        ...
        <table width="740" cellspacing="0" cellpadding="2">
            ...
            <tr>
                ...
                <td class="td14a" style="text-align: right">Total Charges:</td>
