...
{
    public partial class OpenOrders : System.Web.UI.UserControl
    {
        ...
        void BindDataGrid()
        {
            ...
            cmdSelect.CommandText = "SELECT o.OrderDate,o.OrderNumb,c.fName + ' ' + c.lName AS Customer,s.StoreID,s.StoreName, m.MarketName, " +
                "v.VendorID,v.VendorName As Vendor,o.PurchasePrice,o.Actual,o.OrderPrice," +
                "CASE WHEN o.InstallDate > '01/01/2000' THEN o.InstallDate ELSE NULL END As InstallDate," + 
